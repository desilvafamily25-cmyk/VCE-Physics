"""Deterministic extraction of the 2020 VCE Physics examination report --
...
2020 uses the 2017-2023 study design (see data/curriculum/study-design-
...
Outputs:
  data/raw/2020-report-extract.json
  data/answers/2020.json
  public/answer-images/2020-*.png
"""
import json
import sys
...
REPORT_PATH = ROOT / "previous-design-2017-2023" / "2020-physics-report.docx"
SOURCE_DOCUMENT = "2020-physics-report.docx"
YEAR = "2020"
RAW_OUT = ROOT / "data" / "raw" / "2020-report-extract.json"
ANSWERS_OUT = ROOT / "data" / "answers" / "2020.json"
