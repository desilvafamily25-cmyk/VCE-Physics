"""Deterministic extraction of the 2017 VCE Physics examination report --
...
Outputs:
  data/raw/2017-report-extract.json
  data/answers/2017.json
  public/answer-images/2017-b*.png
"""
import json
import sys
...
REPORT_PATH = ROOT / "previous-design-2017-2023" / "2017-physics-report.pdf"
SOURCE_DOCUMENT = "2017-physics-report.pdf"
YEAR = "2017"
RAW_OUT = ROOT / "data" / "raw" / "2017-report-extract.json"
ANSWERS_OUT = ROOT / "data" / "answers" / "2017.json"
