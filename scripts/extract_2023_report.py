"""Deterministic extraction of the 2023 VCE Physics examination report --
...
2023 is a "previous design" (2017-2023 study design) year, but its report
docx uses the same table/heading structure as the current-design reports
(Section A percentage-per-option table, Section B "Question Na." headings
with marks-distribution tables) -- confirmed by direct inspection -- so no
extraction-logic changes were needed, only new source paths.

Outputs:
  data/raw/2023-report-extract.json
  data/answers/2023.json
  public/answer-images/2023-*.png
"""
import json
import sys
...
REPORT_PATH = ROOT / "previous-design-2017-2023" / "2023-physics-report.docx"
SOURCE_DOCUMENT = "2023-physics-report.docx"
YEAR = "2023"
RAW_OUT = ROOT / "data" / "raw" / "2023-report-extract.json"
ANSWERS_OUT = ROOT / "data" / "answers" / "2023.json"
