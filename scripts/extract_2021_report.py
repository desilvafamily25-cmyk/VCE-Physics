"""Deterministic extraction of the 2021 VCE Physics examination report --
...
2021 uses the 2017-2023 study design (see data/curriculum/study-design-
...
Outputs:
  data/raw/2021-report-extract.json
  data/answers/2021.json
  public/answer-images/2021-*.png
"""
import json
import sys
...
REPORT_PATH = ROOT / "previous-design-2017-2023" / "2021-physics-report.docx"
SOURCE_DOCUMENT = "2021-physics-report.docx"
YEAR = "2021"
RAW_OUT = ROOT / "data" / "raw" / "2021-report-extract.json"
ANSWERS_OUT = ROOT / "data" / "answers" / "2021.json"
